...
// (components/hud/TouchControls.jsx) needs the width of landscape; in portrait
// the stick and the action cluster crowd the middle of the scene. Shown only
// once the session is judged touch-driven — a narrow desktop window is left
// alone — and it swallows input while up so nothing is played sideways.
function isPortrait() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-xs text-sm leading-6 text-slate-400">
        Laser Escape plays in landscape. Turn your phone sideways to keep going.
      </div>
